...
**Weather check before planting day:** Postpone to W17 if soil is frozen or heavy frost is forecast. All crops in this phase are frost-tolerant, so light frost AFTER planting is fine.

---

## Pre-Planting Craft Activity -- Painted Plant Markers (W15)

**When:** Any evening in W15 (the week before planting day)
**Duration:** 30-45 minutes
**Purpose:** Builds anticipation for planting day and gives him ownership markers for his bed

### Materials
- 8-12 blank wooden plant markers (from byggemarked or craft store)
- Small set of acrylic paint (outdoor-rated if possible)
- 2-3 brushes (different sizes)
- Newspaper or old tablecloth to protect the table
...
### Transition to Planting Day
"These go in YOUR bed on planting day. You can put each one next to its plant."

---

## W16 -- Big Planting Day

### Prep -- Before the Child Joins (~20 min)

Do this while he is still having breakfast or getting dressed.
...
- Dig holes for sensory plants at the bed edges
...
**Say:** "Your bed is planted! Let's have a snack and look at it from the path."

Walk to the garden table together. Do NOT start the next session immediately.

---

### Break -- Snack + Admire (~10-15 min)

**This break is mandatory.** It resets attention and energy for Session 2.

- Sit at the garden table together
- Eat the fruit/crackers and drink water
- Look at his bed from the walking path -- a different perspective than being right next to it
- Count how many plants are in his bed together ("Let's count -- one strawberry, two strawberry...")
...
- [ ] Put tools away together -- he carries the small tools, you carry the large ones
- [ ] Final watering round of all planted beds (he uses the small can on his bed, you handle the rest)
- [ ] Take a photo together with the planted beds -- **this is the milestone photo**
- [ ] If he wants to visit his bed one more time, let him

**Say:** "We built a garden today. Tomorrow morning, first thing, we go check on it."
...
## W17 -- Follow-Up Session (~30 min)

**When:** The following weekend after planting day
**Purpose:** First succession sowing + germination check + optional bug hotel activity
...
1. **Check germination** -- Walk all planted beds together
   ...
   - Strawberry plugs should look alive (green leaves, not brown)
...
4. **Bug hotel transition** (if building the bug hotel this weekend)
   - "Remember the nature corner we marked last week? Today we build the bug hotel!"
   - See `docs/bug-hotel-guide.md` for the full construction guide

---

## W18 -- Follow-Up Session (~30 min)

**When:** Two weekends after planting day
**Purpose:** Second succession sowing + thinning + optional bug hotel + second water station
...
3. **Thin overcrowded seedlings**
   - If radish seedlings are too close together, thin to 5 cm apart
   - Father demonstrates by pulling one seedling gently
   - He pulls 1-2 seedlings himself
   - "We are giving each plant more room to grow big"
...
Postpone to the next weekend. All crops in this plan are frost-tolerant and the timing is flexible within W16-W18. Nothing is lost by waiting one week.

### Meltdown During Planting
...
### Seeds Do Not Germinate Within 2 Weeks

Re-sow. This is completely normal and happens to experienced gardeners too.

- "Sometimes seeds need a second try. Even farmers re-sow."
- The succession sowing slots in W17-W18 naturally cover this -- treat a re-sow as a scheduled succession round

### Forgot to Water for a Day

One missed day will not kill anything at this stage. The soil in the raised beds retains moisture, and spring weather in Denmark is rarely hot enough to dry beds out in a single day.

- Resume daily watering the next day
- If beds look dry on the surface, give them an extra-long watering session

### He Loses Interest After Planting Day

This is expected and normal. Maintain the garden yourself for a few weeks. When the first radish is ready to pull, or the first strawberry turns red, invite him back. Quick harvests are designed into the plant selection specifically for this reason.

---

## Quick Reference -- Motor Skill Split
...
| Plant markers | **He does it** | Placing painted markers in his bed |
